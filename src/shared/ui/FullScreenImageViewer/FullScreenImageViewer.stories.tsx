...
export default {
    ...
    component: FullScreenImageViewer as ComponentMeta<typeof FullScreenImageViewer>
}

export const Base: ComponentStory<typeof FullScreenImageViewer> = (args) => <FullScreenImageViewer {...args} />
